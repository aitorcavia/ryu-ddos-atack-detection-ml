...
class MachineLearning():
    ...
    def Confusion_matrix(self):
        ...
        print("porcentaje de exito accuracy = {0:.2f} %".format(acc*100))
        fail = 1.0 - acc
        print("porcentaje de fallo = {0:.2f} %".format(fail*100))
        print("------------------------------------------------------------------------------")
...
def main():
    ...
    print("Tiempo de APRENDIZAJE Y PREDICCION: ", (end-start)) 
    ...
    print("Tiempo total: ", (end_script-start_script))
